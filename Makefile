...
PROGRAM_NAME = MineGL
TARGETS = main.cpp $(SRC_FOLDER)/game.cpp $(SRC_FOLDER)/globals.cpp $(SRC_FOLDER)/gpu_program.cpp $(SRC_FOLDER)/shaders_provider.cpp  $(SRC_FOLDER)/callbacks.cpp $(SRC_FOLDER)/lib/glad.c $(SRC_FOLDER)/text_rendering.cpp $(SRC_FOLDER)/window_provider.cpp
LIBS = libglfw3.a
